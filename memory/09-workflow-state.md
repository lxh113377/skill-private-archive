...
| W-46b | P1 | 清 noise_falsepositive_*.json 死句柄（补生成器或按 R241 摘牌留注），再把「pattern 必须有生成器」接进 run_gates 判红（r58 误报率 30.6% 已量清，真死句柄仅 1 条） | todo | - | - | 2026-09-26 12:31 | - |
| R58-1 | P1 | 第17维纵深：把「仓外输入固定」推广到受管根 clone/镜像面（21 道门读本地字节，与 CI 读 checkout 字节同构） | todo | - | - | 2026-09-26 12:31 | - |
